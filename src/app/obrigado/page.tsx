  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      <div className="text-center max-w-md">
        ...
        <Link
          href="/"
          className={`border cursor-pointer border-gold bg-gold p-6 text-white-500 rounded-2xl w-full flex text-center drop-shadow-[0_5px_5px_rgba(255,176,1,0.4)] md:h-20`}
        >
